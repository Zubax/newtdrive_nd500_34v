...
Zubax Sadulli is a tightly integrated unit that contains an electric motor with an electronic speed controller (ESC). 
...
an electric motor with a sensorless electronic speed controller in a single monolithic package. 
...
\begin{ZubaxSimpleTable}{Mechanical characteristics}{|c l|c|c|c|X|}
    ...
    IP     & Protection  & 65      & 65      & -    & The ESC is conformally coated to protect 
                                                      from wet conditions \\                        
\end{ZubaxSimpleTable}
