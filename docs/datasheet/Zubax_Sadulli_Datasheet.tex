...
Sadulli Piccino can be applied for light multirotor aircraft with takeoff weight 500 - 600  g/rotor. While Sadulli Grosso can be applied for multirotor aircraft with  takeoff weight 1300-1800 g/rotor. 
...
\begin{ZubaxSimpleTable}{Motor}{|c X|c|c|c|}
	...
	Kv  & Voltage coefficient   & 330 & 330 & rpm/V\\
	    & Weight                & 166 &     & g\\
\end{ZubaxSimpleTable}

\section{Power characteristics of the Sadulli ESC}
...
\begin{ZubaxTableWrapper}{Power characteristics}
    \begin{ZubaxWrappedTable}{|c X|c c c|c|}
        ...
        $V_\text{inv}$      & Supply voltage\tnote{a}             & 11    & 25.2 & 36.0 & V \\
...
Connector of the unused CAN bus interface should be left empty.
...
\begin{figure}[hb]
    \includegraphics[width=0.45\textwidth]{Sadulli_grosso_Drawing} \includegraphics[width=0.45\textwidth]{Sadulli_piccino_Drawing}
   \left
   \caption{Sadulli-grosso.}
   \right\
   \caption{Sadulli-piccino.}
   
	\label{Sadulli_drawings}}
\end{figure}
